...
        const { id, credit_price, gem_price, is_premium, is_hidden, css_content } = req.body;
        await db.query(
            'UPDATE name_styles SET credit_price = ?, gem_price = ?, is_premium = ?, is_hidden = ?, css_content = ? WHERE id = ?', 
            [credit_price, gem_price, is_premium ? 1 : 0, is_hidden ? 1 : 0, css_content || null, id]
        );
