    ...
    io.on('connection', (socket) => {
            ...
            try {
                ...
                if (currentUser) {
                    ...
                    const appendMeIfNeeded = async (list, scoreField, key) => {
                        ...
                        const meInTop5 = top5.find(u => String(u.tg_id) === String(currentUser));
                        if (!meInTop5) {
                    ...
                    // Essential updates to populate user's bottom ranking for Guessers too!
                    await appendMeIfNeeded(guessers, 'guesses', weekKey);
                    await appendMeIfNeeded(prevGuessers, 'guesses', prevWeekKey);
                }
        ...
        socket.on('claim_top_inviter_reward', async () => {
            ...
            try {
                ...
                const inTop5 = top5.find(u => String(u.tg_id) === String(currentUser));
                if (!inTop5) {
